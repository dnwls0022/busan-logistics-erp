...
function App() {
  ...
  return (
    <div style={{ display: 'flex', width: '100vw', height: '100vh', backgroundColor: '#ece5dc', overflow: 'hidden' }}>
      {/* 1. 왼쪽 고정 사이드바 */}
      ...
      {/* 2. 오른쪽 메인 콘텐츠 영역 */}
      <div style={{ flex: 1, height: '100vh', overflowY: 'auto', padding: '130px', backgroundColor: '#f7f4ef' }}>
        <Routes>
